...
$routes = @{
    "/ola" = { return '<html><body>HostComponentCommunicationsExplorer.ps1</body></html>' }
}
...
cd "..\bin\component-communication"

Write-Host "Started: HostComponentAPIDocs.ps1"
Write-Host "Listening at $url..."
Write-Host "Server shutdown: /kill"
